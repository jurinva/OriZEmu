...
function DiskFileSeekAbs(hf: THANDLE; distance: int64; MoveMethod: DWORD):boolean;
...
// file). Addressed by LBA-number (512bytes record number)
//---------------------------------------------------------------------
function DiskFileSeek(hf: THANDLE; distance: int64; MoveMethod: DWORD):boolean;
...
// Addressed by absolute filepointer (byte-positioned)
function DiskFileSeekAbs(hf: THANDLE; distance: int64; MoveMethod: DWORD):boolean;
